...
void FreeIMU::init() {
  ...
  #elif  HAS_L3G4200D()
  init(FIMU_ACC_ADDR,L3G4200D_Address , false);
  #else
...
void FreeIMU::init(bool fastmode) {
  ...
  #elif  HAS_L3G4200D()
  init(FIMU_ACC_ADDR,L3G4200D_Address ,fastmode);
  #else
...
void FreeIMU::init(int accgyro_addr, bool fastmode) {
  ...
  #if HAS_L3G4200D()
  // init L3G4200D
  gyro.init(2000); // different init then ITG3200 see L3G4200D library
  delay(1000);
  // calibrate the L3G4200D
  gyro.zeroCalibrate(256,5);
  #endif
